...
export default function LeftPanel() {
  ...
  return (
    <aside className="hidden h-full border-r border-zinc-900/10 p-4 lg:fixed lg:inset-0 lg:z-40 lg:block lg:w-56 lg:p-6 dark:border-white/10">
      ...
      <div className="mb-4">
        <h6 className="!text-xs">Quickstart</h6>
      ...
      <div className="my-4">
        <h6 className="mb-2 !text-xs">Foundations</h6>
      ...
      <div className="my-4">
        <h6 className="mb-2 !text-xs">Components</h6>
        <ul className="border-l border-zinc-900/10 pl-4 dark:border-white/10">
      ...
      <div className="my-4">
        <h6 className="mb-2 !text-xs">Hooks</h6>
        <ul className="border-l border-zinc-900/10 pl-4 dark:border-white/10">
          {hooks.map((item, i) => {
            return <LeftPanelMenu item={item} key={i} />
          })}
      ...
      <div className="my-4">
        <h6 className="mb-2 !text-xs">Utilities</h6>
        <ul className="border-l border-zinc-900/10 pl-4 dark:border-white/10">
